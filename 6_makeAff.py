...
######################################################################################
fs_22_2007_2010 = pd.read_csv('../data/afterFS/4/22/2007-2010.csv')
fs_22_2009_2012 = pd.read_csv('../data/afterFS/4/22/2009-2012.csv')
fs_22_2011_2014 = pd.read_csv('../data/afterFS/4/22/2011-2014.csv')
fs_22_2013_2016 = pd.read_csv('../data/afterFS/4/22/2013-2016.csv')
fs_22_2015_2018 = pd.read_csv('../data/afterFS/4/22/2015-2018.csv')

fs_31_2007_2010 = pd.read_csv('../data/afterFS/4/31/2007-2010.csv')
fs_31_2009_2012 = pd.read_csv('../data/afterFS/4/31/2009-2012.csv')
fs_31_2011_2014 = pd.read_csv('../data/afterFS/4/31/2011-2014.csv')
fs_31_2013_2016 = pd.read_csv('../data/afterFS/4/31/2013-2016.csv')
fs_31_2015_2018 = pd.read_csv('../data/afterFS/4/31/2015-2018.csv')

fs_33_2007_2012 = pd.read_csv('../data/afterFS/6/33/2007-2012.csv')
fs_33_2010_2015 = pd.read_csv('../data/afterFS/6/33/2010-2015.csv')
fs_33_2013_2018 = pd.read_csv('../data/afterFS/6/33/2013-2018.csv')

fs_42_2007_2012 = pd.read_csv('../data/afterFS/6/42/2007-2012.csv')
fs_42_2010_2015 = pd.read_csv('../data/afterFS/6/42/2010-2015.csv')
fs_42_2013_2018 = pd.read_csv('../data/afterFS/6/42/2013-2018.csv')

fs_44_2007_2014 = pd.read_csv('../data/afterFS/8/44/2007-2014.csv')
fs_44_2011_2018 = pd.read_csv('../data/afterFS/8/44/2011-2018.csv')
...
# arff_origin_2015_2018 = open("../data/arff/original/original_2015_2018.arff",'w')
#
...
######################################################################################
# arff_fs_22_2007_2010 = open("../data/arff/afterFS/4/22/fs_2007_2010.arff",'w')
# arff_fs_22_2009_2012 = open("../data/arff/afterFS/4/22/fs_2009_2012.arff",'w')
# arff_fs_22_2011_2014 = open("../data/arff/afterFS/4/22/fs_2011_2014.arff",'w')
arff_fs_22_2013_2016 = open("../data/arff/afterFS/4/22/fs_2013_2016.arff",'w')
# arff_fs_22_2015_2018 = open("../data/arff/afterFS/4/22/fs_2015_2018.arff",'w')

# arff_fs_31_2007_2010 = open("../data/arff/afterFS/4/31/fs_2007_2010.arff",'w')
# arff_fs_31_2009_2012 = open("../data/arff/afterFS/4/31/fs_2009_2012.arff",'w')
# arff_fs_31_2011_2014 = open("../data/arff/afterFS/4/31/fs_2011_2014.arff",'w')
arff_fs_31_2013_2016 = open("../data/arff/afterFS/4/31/fs_2013_2016.arff",'w')
# arff_fs_31_2015_2018 = open("../data/arff/afterFS/4/31/fs_2015_2018.arff",'w')

# arff_fs_33_2007_2012 = open("../data/arff/afterFS/6/33/fs_2007_2012.arff",'w')
# arff_fs_33_2010_2015 = open("../data/arff/afterFS/6/33/fs_2010_2015.arff",'w')
arff_fs_33_2013_2018 = open("../data/arff/afterFS/6/33/fs_2013_2018.arff",'w')

# arff_fs_42_2007_2012 = open("../data/arff/afterFS/6/42/fs_2007_2012.arff",'w')
# arff_fs_42_2010_2015 = open("../data/arff/afterFS/6/42/fs_2010_2015.arff",'w')
# arff_fs_42_2013_2018 = open("../data/arff/afterFS/6/42/fs_2013_2018.arff",'w')

# arff_fs_44_2007_2014 = open("../data/arff/afterFS/8/44/fs_2007_2014.arff",'w')
arff_fs_44_2011_2018 = open("../data/arff/afterFS/8/44/fs_2011_2018.arff",'w')
